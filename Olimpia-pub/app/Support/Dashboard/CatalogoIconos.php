...
final class CatalogoIconos
{
    ...
    private const TRAZOS = [
        ...
        'cajas' => '<path d="M8.4 4.6 13.8 2.2 19.2 4.6 13.8 7Z"/>'
            .'<path d="M8.4 4.6v4.8L13.8 11.8V7"/>'
            .'<path d="M19.2 4.6v4.8L13.8 11.8"/>'
            .'<path d="M4.8 11.4 12 8.2l7.2 3.2-7.2 3.2L4.8 11.4Z"/>'
            .'<path d="M4.8 11.4v6.2L12 20.8v-6.2"/>'
            .'<path d="M19.2 11.4v6.2L12 20.8"/>',
        ...
        'estrella' => '<path d="M12 3.2 14.4 9.1l6.3.5-4.9 4 1.6 6.2L12 16.6 6.6 19.8l1.6-6.2-4.9-4 6.3-.5L12 3.2Z"/>',
        'taza' => '<path d="M4.4 8.2h11.4v6.2a4.6 4.6 0 0 1-4.6 4.6H9A4.6 4.6 0 0 1 4.4 14.4V8.2Z"/>'
            .'<path d="M15.8 9.6h2a2.7 2.7 0 1 1 0 5.4h-2"/>'
            .'<path d="M8 3.4c.45.9.45 1.7 0 2.6M11.2 3.4c.45.9.45 1.7 0 2.6"/>'
            .'<path d="M5.2 20.6h10.2"/>',
        'pan' => '<path d="M4.2 13.4c0-3.8 3.5-7 7.8-7s7.8 3.2 7.8 7-3.5 5.4-7.8 5.4-7.8-1.6-7.8-5.4Z"/>'
            .'<path d="M8.2 10.4c.7-.9 1.8-1.4 3.1-1.4M13.4 9.2c.9-.35 1.9-.3 2.8.3"/>'
